...
public class Arista {
	...
	/*
	 * @Override public boolean equals(Object otroObjeto) { // Verificar si ambos
	 * objetos son la misma instancia if (this == otroObjeto) { return true; }
	 * 
	 * // Verificar si el otro objeto es nulo y si son de la misma clase if
	 * (otroObjeto == null || getClass() != otroObjeto.getClass()) { return false; }
	 * 
	 * // Hacer un casting del otro objeto a la clase actual Arista otraArista =
	 * (Arista) otroObjeto;
	 * 
	 * 
	 * // Comparar los atributos que definen la igualdad return (
	 * persona1().equals(otraArista.persona1) &&
	 * persona2().equals(otraArista.persona2) ) || (
	 * persona1().equals(otraArista.persona2) &&
	 * persona2().equals(otraArista.persona1) ); }
	 */
